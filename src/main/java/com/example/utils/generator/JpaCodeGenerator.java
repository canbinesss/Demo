...
public class JpaCodeGenerator {
     ...
     * @throws SQLException
     */
    static List<com.example.utils.generator.TableColumn> getTableColumns(String tableName) throws SQLException {
        ...
        List<com.example.utils.generator.TableColumn> columnList = Lists.newArrayList();
        for (Entity entity : user) {
            com.example.utils.generator.TableColumn tableColumn = new com.example.utils.generator.TableColumn();
    ...
    static void createEntity(String tableName, String entityName) throws SQLException {
        List<com.example.utils.generator.TableColumn> columnList = getTableColumns(tableName);
        ...
        for (com.example.utils.generator.TableColumn tableColumn : columnList) {
    ...
    static void createVueHtml(String entityName, String tableName) throws SQLException {
        ...
        List<com.example.utils.generator.TableColumn> tableColumns = getTableColumns(tableName);
        JSONArray array = new JSONArray();
        for (com.example.utils.generator.TableColumn tableColumn : tableColumns) {
