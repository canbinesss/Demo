package com.example.utils.word;
 ...
 * @since 2017-12-28
 * @version 1.0
 * 参考地址：http://blog.csdn.net/kunkun378263/article/details/38492743
 */
public class PinyingUtil {
	 ...
	 * @return
	 */
	public static String getPYCode(String src){
		StringBuilder result = new StringBuilder();
		String[]  s_array = stringToPinyin(src, false, null);
		
		for(String s : s_array){
			if(!"".equals(s.trim())){
				String first = s.substring(0, 1);
				result.append(first.toUpperCase());
			}
		}		
		return result.toString();
	}
	
	public static String getPYAllCode(String src){
		StringBuilder result = new StringBuilder();
		String[]  s_array = stringToPinyin(src, false, null);
		...
		for(String s : s_array){
			if(!"".equals(s.trim())){
				...
				result.append(first.toUpperCase()+other);
			}
		}		
		return result.toString();
	}
	...
	*/
	...
	public static void main(String args[]) { 
		String sss= "中华";
		String aa = getPYCode(sss);
		String bb = getPYAllCode(sss);
